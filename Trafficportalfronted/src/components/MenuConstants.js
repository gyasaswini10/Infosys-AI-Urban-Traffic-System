...
export const MANAGER_MENU = [
    ...
    { mid: 3, menu: "Drivers", icon: "/images/driver.png", view: "drivers" },
    { mid: 4, menu: "Maintenance", icon: "/images/maintenance.png", view: "maintenance" },
    { mid: 5, menu: "Traffic View", icon: "/images/traffic_view.png", view: "traffic_view" },
    { mid: 6, menu: "Reports", icon: "/images/report.png", view: "reports" },
    { mid: 7, menu: "Profile", icon: "/images/profile.png", view: "profile" }
];
